...
import { IconCalendarMonth, IconGripVertical, IconPencil, IconPlus, IconTrash, IconX } from "@tabler/icons-react";
        ...
        {columns.map(column => {
          ...
          >
            <div className="mb-3 flex items-center justify-between">
              ...
              <button onClick={() => openCreate(column.key)} className="rounded-md p-0.5 text-slate-400 transition hover:bg-slate-200 hover:text-slate-600"><IconPlus className="size-4" /></button>
            </div>
